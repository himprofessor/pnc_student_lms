      ...
      if (error.response) {
        ...
        if (status === 422 && responseData.errors) {
          ...
          for (const key in responseData.errors) {
            const fieldName = key.replace(/\./g, '_') as keyof typeof fieldErrors;
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerSub}>Fill out the form below to request leave from your studies</Text>
      </View>
      ...
      <View style={styles.formContainer}>
        ...
        <View style={styles.inputGroup}>
          ...
          <View style={[styles.pickerContainer, fieldErrors.leave_type_id ? styles.errorBorder : null]}>
            <Picker
              selectedValue={form.leave_type_id}
              onValueChange={(itemValue) => setForm({ ...form, leave_type_id: itemValue })}
            >
          ...
          {fieldErrors.leave_type_id ? <Text style={styles.errorText}>{fieldErrors.leave_type_id}</Text> : null}
        </View>
        ...
        <View style={styles.inputGroup}>
          ...
          <TextInput
            style={[styles.textArea, fieldErrors.reason ? styles.errorBorder : null]}
            value={form.reason}
            ...
            numberOfLines={4}
          />
          {fieldErrors.reason ? <Text style={styles.errorText}>{fieldErrors.reason}</Text> : null}
        </View>
        ...
        <View style={styles.inputGroup}>
          ...
          {fieldErrors.supporting_documents ? (
            <Text style={styles.errorText}>{fieldErrors.supporting_documents}</Text>
          ) : null}
        </View>
