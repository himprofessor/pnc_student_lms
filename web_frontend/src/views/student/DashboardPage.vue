          ...
          <div class="bg-white rounded-2xl w-full max-w-md shadow-2xl overflow-hidden">
            ...
            <div class="p-6" v-if="selectedNotification">
              <div class="flex items-start space-x-3 mb-4">
                <svg v-if="selectedNotification.type === 'leave_approved'" class="w-8 h-8 text-green-500 flex-shrink-0"
              ...
              <div v-if="selectedNotification.data" class="bg-gray-50 rounded-lg p-4 mb-4">
                ...
                <div class="text-sm text-gray-600">
                  <p v-if="selectedNotification.data.leave_type">
                    ...
                    {{ selectedNotification.data.leave_type }}
                  </p>
                  <p v-if="
                    selectedNotification.data.from_date &&
                    selectedNotification.data.to_date
                  ">
                  ...
                  <p v-if="selectedNotification.data.approved_by">
                    ...
                    {{ selectedNotification.data.approved_by }}
                  </p>
