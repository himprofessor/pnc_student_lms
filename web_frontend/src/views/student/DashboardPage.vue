<template>
  <div class="min-h-screen bg-gray-50 text-gray-800">
      <div class="px-6 py-6">
                      ...
                      <div v-if="showNotificationSummary"
                          ...
                          <div class="p-6 border-b">
                              <div class="flex justify-between items-center">
                                  ...
                                  <button @click="showNotificationSummary = false"
          ...
          <!-- ... existing code ... (Summary Cards section remains unchanged) -->
          ...
          <!-- ... existing code ... (Recent Leave Requests section remains unchanged) -->
 ...
 <!--dashboard leave request -->
      <div class="bg-white rounded-lg shadow border mb-6" ref="notificationsSection">
        <div class="border-b px-6 py-4 bg-gradient-to-r from-blue-50 to-indigo-50">
          ...
          <p class="text-sm text-gray-600 mt-1">Your latest leave request updates</p>
        </div>
