  ...
  <div class="min-h-screen bg-gray-50 text-gray-800">
    ...
    <div class="px-6 py-6">
      <div class="flex justify-between items-center mb-6">
        ...
        <button class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-md text-sm font-medium flex items-center space-x-1">
        ...
        <div class="divide-y">
          <div class="flex justify-between items-center px-6 py-4">
            <div class="flex items-center space-x-3">
              ...
              <div>
                <div class="font-semibold">Sick Leave</div>
                <div class="text-sm text-gray-500">Jan 15, 2024 - Jan 17, 2024</div>
                <div class="text-sm text-gray-500">Flu symptoms</div>
              </div>
            </div>
            <div class="flex items-center space-x-2">
              <span class="bg-yellow-100 text-yellow-700 text-xs font-medium px-2 py-1 rounded">Pending</span>
              <button class="text-red-500 text-xs font-semibold hover:underline">Cancel</button>
            </div>
          </div>

          <div class="flex justify-between items-center px-6 py-4">
            <div class="flex items-center space-x-3">
              <svg class="w-6 h-6 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h2a2 2 0 002-2V7a2 2 0 00-2-2h-3M7 11v10a2 2 0 002 2h6a2 2 0 002-2v-3m-7-3V7a2 2 0 012-2h6a2 2 0 012 2v6m-7 3v4"></path></svg>
              <div>
                <div class="font-semibold">Family Emergency</div>
                <div class="text-sm text-gray-500">Jan 20, 2024 - Jan 22, 2024</div>
                <div class="text-sm text-gray-500">Family emergency</div>
              </div>
            </div>
            <div>
              <span class="bg-green-100 text-green-700 text-xs font-medium px-2 py-1 rounded">Approved</span>
            </div>
          </div>
        </div>
      </div>
...
<script setup>
// You can fetch data from API or Vuex store if needed
</script>