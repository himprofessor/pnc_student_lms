      ...
      <div class="bg-white rounded-lg p-6 max-w-md w-full shadow-lg">
        <div class="flex justify-between items-center mb-4">
          ...
          <button @click="selectedAbsence = null"
            class="text-gray-500 hover:text-gray-700 focus:outline-none text-2xl leading-none" aria-label="Close modal">
            &times;
          </button>
        </div>
        <div v-if="selectedAbsence" class="space-y-3 text-gray-800 text-sm">
          ...
          <p><span class="font-semibold">Period:</span> {{ selectedAbsence.from_date }} to {{ selectedAbsence.to_date }}
          </p>
